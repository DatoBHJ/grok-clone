...
const getHostname = (url: string): string => {
  try {
    ...
    // Return a fallback domain or the original URL if invalid
...
const getFaviconUrl = (url: string): string => {
  ...
  return hostname !== 'unknown-domain'
    ...
    : 'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"%3E%3Crect width="20" height="20" x="2" y="2" rx="4"%3E%3C/rect%3E%3C/svg%3E';
};
          ...
          {links.slice(0, 4).map((link, i) => (
            ...
            >
              <img 
                ...
                className="w-3 h-3"
                onError={(e) => {
                  e.currentTarget.src = 'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"%3E%3Crect width="20" height="20" x="2" y="2" rx="4"%3E%3C/rect%3E%3C/svg%3E';
                }}
              />
            </div>
          ))}
            ...
            <div key={index} className="bg-gray-50 dark:bg-zinc-900 p-4 rounded-lg">
              ...
              >
                ...
                <div className="mt-3 flex items-center gap-2">
                  ...
                  />
                  <span className="text-sm text-gray-500 dark:text-zinc-500">
                    {link.domain || getHostname(link.url)}
                  </span>
                </div>
              </a>
            </div>
